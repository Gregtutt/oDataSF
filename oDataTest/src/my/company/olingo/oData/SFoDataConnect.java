...
public class SFoDataConnect {
	...
	this.destConfiguration = configuration.getConfiguration("successfactorsOdataDestination");
	...
	for (EdmEntitySet entity : edm.getEntitySets()) {
	    ...
	    if ( ! entity.getName().startsWith("PerPerson")) continue;
	...
	if ( annotAttributes == null ) return;
